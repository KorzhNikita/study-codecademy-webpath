...
/*Employee.*/export const getCadre = function () {
...
/*Employee.*/export const calculateTax = function () {
  return payGrades[/*Employee.*/getCadre()].taxMultiplier * Employee.salary;
}

/*Employee.*/export const getBenefits = function () {
  return payGrades[/*Employee.*/getCadre()].benefits.join(', ');
}

/*Employee.*/export const calculateBonus = function () {
  return .02 * Employee.salary;
}

/*Employee.*/export const reimbursementEligibility = function () {
